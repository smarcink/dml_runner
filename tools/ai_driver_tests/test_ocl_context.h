...
class ResourceOCL : public ai_driver::Resource<ResourceOCL>
{
public:
    ResourceOCL() = default;
...
class KernelOCL : public ai_driver::Kernel<KernelOCL>
{
public:
...
class StreamOCL : public ai_driver::Stream<StreamOCL>
{
public:
...
class DeviceOCL : public ai_driver::Device<DeviceOCL>
{
public:
    DeviceOCL()
    {
    ...
    KernelOCL create_kernel(const char* kernel_name, const void* kernel_code, size_t kernel_code_size, const char* build_options, ai_driver_kernel_language_t language)
    {
...
using ContextOCL = ai_driver::Context<DeviceOCL, StreamOCL, ResourceOCL, KernelOCL>;
