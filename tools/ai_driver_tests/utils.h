...
inline std::size_t accumulate_tensor_dims(const ai_driver_tensor_t& tensor)
{
    std::size_t ret = 1;
...
inline std::size_t accumulate_tensor_dims(const ai_driver::Tensor& tensor)
{
    std::size_t ret = 1;
...
inline std::vector<std::uint8_t> randomize_linear_container_float(const ai_driver::Tensor& tensor, float random_min, float random_max)
{
