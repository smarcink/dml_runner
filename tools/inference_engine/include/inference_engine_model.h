...
INFERENCE_ENGINE_API void inferenceEngineSetNodeName(inference_engine_model_descriptor_t model_desc, inference_engine_node_id_t node_id, const char* name);
