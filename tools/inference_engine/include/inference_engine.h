...
{
    INFERENCE_ENGINE_KERNEL_LANGUAGE_OCL = 0,
...
typedef void(*FN_GPU_KERNEL_SET_ARG_RESOURCE)(inference_engine_kernel_t kernel, uint32_t index, inference_engine_resource_t resource, size_t offset);
